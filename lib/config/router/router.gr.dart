...
class AccountRoleRoute extends _i31.PageRouteInfo<void> {
  const AccountRoleRoute({List<_i31.PageRouteInfo>? children})
...
class AppBottomNavBarRoute extends _i31.PageRouteInfo<void> {
  const AppBottomNavBarRoute({List<_i31.PageRouteInfo>? children})
...
class BiometricAuthenticationRoute extends _i31.PageRouteInfo<void> {
  const BiometricAuthenticationRoute({List<_i31.PageRouteInfo>? children})
...
/// generated route for
/// [_i6.ChangePinScreen]
class ChangePinRoute extends _i31.PageRouteInfo<void> {
  const ChangePinRoute({List<_i31.PageRouteInfo>? children})
...
class ChangeThemeRoute extends _i31.PageRouteInfo<void> {
  const ChangeThemeRoute({List<_i31.PageRouteInfo>? children})
...
class ConfirmPasswordRoute
    extends _i31.PageRouteInfo<ConfirmPasswordRouteArgs> {
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    ...
    builder: (data) {
      ...
      return _i8.ConfirmPasswordScreen(key: args.key, onSubmit: args.onSubmit);
    },
  );
}
...
class ConfirmPaymentRoute extends _i31.PageRouteInfo<void> {
  const ConfirmPaymentRoute({List<_i31.PageRouteInfo>? children})
...
class ConfirmTransactionPinRoute
    extends _i31.PageRouteInfo<ConfirmTransactionPinRouteArgs> {
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    ...
    builder: (data) {
      ...
      return _i10.ConfirmTransactionPinScreen(
        key: args.key,
...
class CreateAccountRoute extends _i31.PageRouteInfo<CreateAccountRouteArgs> {
  CreateAccountRoute({_i32.Key? key, List<_i31.PageRouteInfo>? children})
    : super(
...
class DriverPayoutRoute extends _i31.PageRouteInfo<void> {
  const DriverPayoutRoute({List<_i31.PageRouteInfo>? children})
...
/// generated route for
/// [_i13.EnterPinScreen]
class EnterPinRoute extends _i31.PageRouteInfo<void> {
  const EnterPinRoute({List<_i31.PageRouteInfo>? children})
...
class ForgotPasswordRoute extends _i31.PageRouteInfo<ForgotPasswordRouteArgs> {
  ForgotPasswordRoute({
    _i32.Key? key,
...
/// generated route for
/// [_i17.LegalScreen]
class LegalRoute extends _i31.PageRouteInfo<LegalRouteArgs> {
  LegalRoute({_i32.Key? key, List<_i31.PageRouteInfo>? children})
    : super(
        LegalRoute.name,
...
class MakePaymentRoute extends _i31.PageRouteInfo<void> {
  const MakePaymentRoute({List<_i31.PageRouteInfo>? children})
...
class OtpRoute extends _i31.PageRouteInfo<OtpRouteArgs> {
  OtpRoute({_i32.Key? key, List<_i31.PageRouteInfo>? children})
    : super(
        OtpRoute.name,
...
/// generated route for
/// [_i24.ReceiptScreen]
class ReceiptRoute extends _i31.PageRouteInfo<ReceiptRouteArgs> {
  ReceiptRoute({_i33.Key? key, List<_i31.PageRouteInfo>? children})
    : super(
        ReceiptRoute.name,
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    ...
    builder: (data) {
      ...
      return _i24.ReceiptScreen(key: args.key);
    },
  );
}
...
class ReferralRoute extends _i31.PageRouteInfo<void> {
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    name,
    builder: (data) {
      return const _i25.ReferralScreen();
    },
  );
}
...
/// generated route for
/// [_i27.SetupDriverAccountScreen]
class SetupDriverAccountRoute extends _i31.PageRouteInfo<void> {
  const SetupDriverAccountRoute({List<_i31.PageRouteInfo>? children})
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    name,
    builder: (data) {
      return const _i27.SetupDriverAccountScreen();
    },
  );
}

/// generated route for
/// [_i28.SetupPassengerAccountScreen]
class SetupPassengerAccountRoute extends _i31.PageRouteInfo<void> {
  const SetupPassengerAccountRoute({List<_i31.PageRouteInfo>? children})
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    name,
    builder: (data) {
      return const _i28.SetupPassengerAccountScreen();
    },
  );
}
...
class SupportRoute extends _i31.PageRouteInfo<void> {
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    name,
    builder: (data) {
      return const _i29.SupportScreen();
    },
  );
}
...
class TransactionPinRoute extends _i31.PageRouteInfo<TransactionPinRouteArgs> {
  TransactionPinRoute({
    _i32.Key? key,
    _i32.ValueSetter<String>? onSubmit,
    List<_i31.PageRouteInfo>? children,
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    ...
    builder: (data) {
      ...
      return _i10.TransactionPinScreen(key: args.key, onSubmit: args.onSubmit);
    },
  );
}
...
/// generated route for
/// [_i30.TransferScreen]
class TransferRoute extends _i31.PageRouteInfo<void> {
  const TransferRoute({List<_i31.PageRouteInfo>? children})
  ...
  static _i31.PageInfo page = _i31.PageInfo(
    name,
    builder: (data) {
      return const _i30.TransferScreen();
    },
  );
}
