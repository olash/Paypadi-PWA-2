...
class _TransactionClient implements TransactionClient {
  _TransactionClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<AccountLookupModel>> getAccountDetails({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(payload);
    final _options = _setStreamType<ApiResponse<AccountLookupModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ApiResponse<AccountLookupModel> _value;
    try {
      _value = ApiResponse<AccountLookupModel>.fromJson(
        _result.data!,
        (json) => AccountLookupModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
