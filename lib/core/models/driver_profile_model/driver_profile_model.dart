...
sealed class DriverProfileModel with _$DriverProfileModel {
  const factory DriverProfileModel({
    ...
    @JsonKey(name: 'license_plate') required String licensePlate, @JsonKey(name: 'created_at') required String createdAt, @JsonKey(name: 'updated_at') required String updatedAt, @JsonKey(name: 'driver_license_number') String? licenseNumber,
